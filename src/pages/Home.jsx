...
//         try{
//             const res = await fetch(`https://localhost:7284/api/Home/SearchTask?keyword=${debouncedSearch}`,{
//                 headers:{
//                     "Content-Type": "application/json",
//                     "Authorization": `Bearer ${token}`
//                 }
    ...
    return (
        <div>
            <Index>
                ...
                <TaskCart modal = {setOpen} tasks={tasks} setTasks= {setTask} setSelectedId = {setSelectedId} searchText={searchText}/>
            </Index>
        </div>
    )
}
